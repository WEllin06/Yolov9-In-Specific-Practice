...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'D:\Desktop\YOLOv9\runs\train\exp9\weights\last.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov9-c.yaml', help='model.yaml path')
